...
Також у нього є необов'язкові параметри, це назва функції та назва змінної (функція, яка аргументом приймає номер змінної). \
...
Також у нього є необов'язковий параметр, це назва змінної (функція, яка аргументом приймає номер змінної). 
...
```ts
{
  ...
  arg: (index: number) => string, // назва аргументу
  char: string, // за замовченням символ "хрестика", символ, який виводиться в комірці
...
```ts
{
  arg: (index: number) => string // назва аргументу, який буде виведений у заголовку таблиці
